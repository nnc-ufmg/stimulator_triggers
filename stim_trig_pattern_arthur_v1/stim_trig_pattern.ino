...
void stimulation_interrupt()
{
  ...
  //if (bInBetweenWords) {if (ulBetweenWordWaitInterval>0) delayMicroseconds(ulBetweenWordWaitInterval);} //if it is grater than zero ... decrease it and leave 
  //   else //We are within a word
       
  if ((bInBetweenWords) && (ulBetweenWordWaitInterval>0)) 
    {
      delayMicroseconds(ulBetweenWordWaitInterval); 
      bInBetweenWords=false;
    };
